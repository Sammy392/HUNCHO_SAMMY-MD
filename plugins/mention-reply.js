...
cmd({
  ...
  try {
    ...
    const botNumber = cmd.user.id.split(":")[0] + '@s.whatsapp.net';
    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await cmd.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "popkid",
            body: config.DESCRIPTION || "popkid",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/tbdd5d.jpg", // Static image URL
    ...
    console.error(e);
    const ownerJid = cmd.user.id.split(":")[0] + "@s.whatsapp.net";
    await cmd.sendMessage(ownerJid, {
